  ...
  if (sesion.rol === "frank") {
    return (
      <div className="min-h-screen flex items-center justify-center p-6 text-center">
        <div className="pr-card p-8 max-w-sm">
          <p className="text-sm text-text-primary mb-4">
            Ya tienes una sesión activa en Panel Administrador. Ciérrala para entrar al Portal Practicantes.
          </p>
          <button onClick={cerrarFrankYContinuar} disabled={cambiando} className="pr-btn-primary w-full inline-flex items-center justify-center gap-2">
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="pr-card p-8">
          ...
          <form onSubmit={onSubmit} className="flex flex-col gap-4">
            ...
            <button type="submit" disabled={enviando} className="pr-btn-primary mt-2">
