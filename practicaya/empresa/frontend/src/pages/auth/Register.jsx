...
const Register = () => {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      const response = await axios.post('http://127.0.0.1:5000/api/auth/register', {
        ...formData,
        role: 'estudiante' // Hardcoded to student based on requirements
      });
  ...
  return (
    <div style={{ 
      ...
      <div className="auth-logo-placeholder" style={{ position: 'absolute', top: '2rem', left: '3rem', fontSize: '1.5rem', fontWeight: 'bold', color: '#D0D3E5' }}>
        Logo
      </div>
        ...
        <form onSubmit={handleRegister}>
          <div style={{ marginBottom: '1.25rem' }}>
            ...
            <input 
              type="text" 
              name="nombre"
              placeholder="Ej. María Fenanda Pérez"
